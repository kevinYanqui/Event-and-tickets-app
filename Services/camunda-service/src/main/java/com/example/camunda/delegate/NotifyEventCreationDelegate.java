...
@Component("notifyEventCreationDelegate")
@RequiredArgsConstructor
public class NotifyEventCreationDelegate implements JavaDelegate {
    ...
    public void execute(DelegateExecution execution) throws Exception {
        ...
        Map<String, Object> evento = (Map<String, Object>) execution.getVariable("evento");

        Map<String, Object> datos = new HashMap<>();
        datos.put("nombreEvento", eventoNombre);
        datos.put("eventoId", evento.get("id"));

        Map<String, Object> notificationRequest = new HashMap<>();
        notificationRequest.put("tipo", "EVENTO_CREADO");
        ...
        execution.setVariable("eventNotificationSent", true);
    }
}
