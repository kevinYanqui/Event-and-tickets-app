import { TicketIcon, EnvelopeIcon, PhoneIcon, MapPinIcon } from '@heroicons/react/24/outline';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-2 text-white mb-4">
              <span className="text-2xl font-bold">Ticket Express</span>
            </div>
            <p className="text-gray-400 mb-4">
              Tu plataforma de confianza para descubrir y comprar entradas a los mejores eventos.
              Conciertos, festivales, deportes y más.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/crear-evento" className="hover:text-teal-500 transition">
                  Crear Evento
                </Link>
              </li>
              <li>
                <Link to="/mis-tickets" className="hover:text-teal-500 transition">
                  Mis Tickets
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-center space-x-3">
                ...
                <span className="text-sm">soporte@ticketexpress.com</span>
              </li>
              <li className="flex items-center space-x-3">
              ...
              <li className="flex items-center space-x-3">
                ...
                <span className="text-sm">Arequipa, Perú</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            © 2025 Ticket Express. Todos los derechos reservados.
          </p>
          <div className="flex space-x-6 mt-4 md:mt-0">
            <a href="#" className="text-gray-400 hover:text-teal-500 text-sm transition">
