...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleReservaNotFound(ReservaNotFoundException ex) {
        log.error("Reserva not found: {}", ex.getMessage());
    ...
    @ExceptionHandler(ReservaExpiredException.class)
    public ResponseEntity<ErrorResponse> handleReservaExpired(ReservaExpiredException ex) {
        log.error("Reserva expired: {}", ex.getMessage());
        ErrorResponse error = new ErrorResponse(
            "RESERVA_EXPIRED",
            ex.getMessage(),
